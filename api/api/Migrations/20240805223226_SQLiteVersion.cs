...
{
    /// <inheritdoc />
    public partial class SQLiteVersion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZone = table.Column<double>(type: "REAL", nullable: true),
                    DST = table.Column<string>(type: "TEXT", nullable: true),
                    TzDatabaseTimeZone = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LegId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TripId = table.Column<int>(type: "INTEGER", nullable: false),
                    DepartureAirportId = table.Column<string>(type: "TEXT", nullable: false),
                    ArrivalAirportId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Portfolios", x => new { x.AppUserId, x.TripId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Portfolios_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "TripId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5dfe217f-da4d-44a2-80a8-2f904e61314c", null, "Admin", "ADMIN" },
                    { "c55e077a-703f-48b4-89e2-84b654ae9ece", null, "User", "USER" }
                });
